...
In this guide, you will use Mumbai EVMBuilder PoS testnet and EVMBuilder Edge local chain. Please make sure you have JSON-RPC endpoint for Mumbai and you've set up EVMBuilder Edge in local environment. Please refer to Local Setup or Cloud Setup for more details.
